    ...
    >
      ...
      <div className="mt-3 px-3">
        ...
        <Link
          ...
          className="block w-full text-center border border-gray-200 text-[11px] uppercase tracking-[0.2em] text-gray-600 py-2.5 hover:border-black hover:text-black transition-colors duration-150"
        >
          В корзину
        </Link>
      </div>
